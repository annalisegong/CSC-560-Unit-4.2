...
//get by ID method get one player ="find-player"
...
//update and delete method don't work bc i can't get the objectID to identify with the id in body
//update method -- put may need to change to 'put'
...
router.delete('/delete/:id', async (req, res) => {
    try{
        ...
        //res.send('Document with '+ player.personal_Details.First_Name + ' has been deleted') need to fix the display name
    }
    catch(error){
        res.status(400).json({message: error.message})
    }
